...
<section class="dateCheck">
    <form id="datecheckform" class="dateCheck__container">
        <div>
            ...
            <input type="date" id="arrival" name="arrival" value="2024-03-24" min="2024-03-01" max="2028-12-31" class="dateCheck__container__input1"/>
        </div>
        <div>
            <label for="departure" class="dateCheck__container__label">LeDeparture Date</label>
            <input type="date" id="departure" name="departure" value="2024-03-30" min="2024-03-25" max="2028-12-31" class="dateCheck__container__input2"/>    
        </div>
...
<section class="homeAbout">
    <div class="homeAbout__firstContainer">
        ...
        <p class="homeAbout__firstContainer__par">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>    
    ...
    <div class="homeAbout__secondContainer">
        <div class="homeAbout__secondContainer__card1">
            ...
            <div class="homeAbout__secondContainer__card1__teamContainer">
                <img src="./assets/home/teamImg.png" alt="" class="homeAbout__secondContainer__card1__teamContainer__img">
                <h1 class="homeAbout__secondContainer__card1__teamContainer__title">Strong Team</h1>
                <p class="homeAbout__secondContainer__card1__teamContainer__par">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
            </div>
        </div>
        ...
        <div class="homeAbout__secondContainer__card2">
            ...
            <div class="homeAbout__secondContainer__card2__roomContainer">
                <img src="./assets/home/teamLuxury.png" alt="" class="homeAbout__secondContainer__card2__roomContainer__img">
                <h1 class="homeAbout__secondContainer__card2__roomContainer__title">Luxury Room</h1>
                <p class="homeAbout__secondContainer__card2__roomContainer__par">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
            </div>
        </div>
    </div>
        ...
        <div class="homerooms__slider__descriptions">
            <div class="homerooms__slider__descriptions__item" id="description1" >
                <div>
                    ...
                    <p class="homerooms__slider__descriptions__item__par">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
...
<section class="intro">
    <div class="intro__container1">
        ...
        <p class="intro__container1__par">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat you have to understand this.</p>
        <button class="intro__container1__btn">BOOK NOW</button>
    </div>
    <div class="intro__container2">
        <iframe class="intro__container2__video" src="https://www.youtube.com/embed/H1CIBqDeWQ0?controls=0&mute=1&showinfo=0&rel=0&autoplay=1&loop=1&playlist=H1CIBqDeWQ0"></iframe>
    </div>
</section>
<section class="facilities">
    ...
    <div id="facilities__slider" class="swiper facilities__slider" >                                                       
        <div class="swiper-wrapper facilities__slider__container"  >
          ...
          <div class="swiper-slide facilities__slider__container__item" style="background-image: url(./assets/home/01.png);">
            ...
            <p class="facilities__slider__container__item__par">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna..</p>
          </div>
          <div class="swiper-slide facilities__slider__container__item" style="background-image: url(./assets/home/02.png);">
          ...
          <div class="swiper-slide facilities__slider__container__item" style="background-image: url(./assets/home/03.png);">
          ...
          <div class="swiper-slide facilities__slider__container__item" style="background-image: url(./assets/home/04.png);">
          ...
          <div class="swiper-slide facilities__slider__container__item" style="background-image: url(./assets/home/05.png);">
          ...
          <div class="swiper-slide facilities__slider__container__item" style="background-image: url(./assets/home/06.png);">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide menu__sliderMenu-slide">
                <div class="menu__sliderMenu-slide-item">
                    <div class="menu__sliderMenu-slide-item__img"><img class="" src="./assets/home/bacon-egg.jpg" alt=""></div>
                ...
                <div class="menu__sliderMenu-slide-item">
                    <div class="menu__sliderMenu-slide-item__img"><img class="" src="./assets/home/coffee.jpg" alt=""></div>
                    <div class="menu__sliderMenu-slide-item__text">
                        <h4>Tea or Coffee</h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.
                ...
                <div class="menu__sliderMenu-slide-item">
                    <div class="menu__sliderMenu-slide-item__img"><img class="" src="./assets/home/chia.jpg" alt=""></div>
                    <div class="menu__sliderMenu-slide-item__text">
                        <h4>Chia Oatmeal</h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.
            ...
            <div class="swiper-slide menu__sliderMenu-slide">
                <div class="menu__sliderMenu-slide-item">
                    <div class="menu__sliderMenu-slide-item__img"><img class="" src="./assets/home/parfait.jpg" alt=""></div>
                    <div class="menu__sliderMenu-slide-item__text">
                        <h4>Fruit Parfait</h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.
                ...
                <div class="menu__sliderMenu-slide-item">
                    <div class="menu__sliderMenu-slide-item__img"><img class="" src="./assets/home/marmalade.jpg" alt=""></div>
                    <div class="menu__sliderMenu-slide-item__text">
                ...
                <div class="menu__sliderMenu-slide-item">
                    <div class="menu__sliderMenu-slide-item__img"><img class="" src="./assets/home/cheese.jpg" alt=""></div>
                    <div class="menu__sliderMenu-slide-item__text">
                        <h4>Cheese Plate</h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.
    ...
    <div class="menu__sliderPics swiper" >
        <div class="menu__sliderPics__container swiper-wrapper">
            <div class="menu__sliderPics__container__item swiper-slide">
                <img class="menu__sliderPics__container__item__img" id="imgCarousel" src="./assets/home/restaurantMeal.jpg">
              </div>
              ...
              <div class="menu__sliderPics__container__item swiper-slide " >
                <img class="menu__sliderPics__container__item__img" id="imgCarousel" src="./assets/home/capuccino.jpg">
              </div>
        </div>
        <div class="swiper-pagination "></div>
    </div>
