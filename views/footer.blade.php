    ...
    <div class="footerContainer__main">
        <div class="footerContainer__main__intro">
            <div class="footerContainer__main__intro__container">
                ...
                <p class="footerContainer__main__intro__container__title2"><b
                        class="footerContainer__main__intro__container__title1">HOTEL</b> MIRANDA</p>
            </div>
            <p class="footerContainer__main__intro__par">Lorem ipsum dolor sit amet, consect etur adipisicing elit, sed
                doing eius mod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
